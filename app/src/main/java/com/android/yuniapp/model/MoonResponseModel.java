...
public class MoonResponseModel implements Parcelable {
    ...
    public MoonResponseModel(){

    }

    protected MoonResponseModel(Parcel in) {
    ...
    public static final Creator<MoonResponseModel> CREATOR = new Creator<MoonResponseModel>() {
        @Override
        public MoonResponseModel createFromParcel(Parcel in) {
            return new MoonResponseModel(in);
        }

        @Override
        public MoonResponseModel[] newArray(int size) {
            return new MoonResponseModel[size];
        }
    };
