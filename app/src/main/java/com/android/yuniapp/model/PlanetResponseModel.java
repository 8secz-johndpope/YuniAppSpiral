...
public class PlanetResponseModel implements Parcelable {
    ...
    public static Creator<PlanetResponseModel> getCREATOR() {
        return CREATOR;
    }

    protected PlanetResponseModel(Parcel in) {
    ...
    public static final Creator<PlanetResponseModel> CREATOR = new Creator<PlanetResponseModel>() {
        @Override
        public PlanetResponseModel createFromParcel(Parcel in) {
            return new PlanetResponseModel(in);
        }

        @Override
        public PlanetResponseModel[] newArray(int size) {
            return new PlanetResponseModel[size];
        }
    };
