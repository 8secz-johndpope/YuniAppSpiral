...
public abstract class AgoraBaseActivity extends AppCompatActivity {
    ...
    protected void onDestroy() {
        deInitUIandEvent();
//        ((YuniApplication)getApplication()).deInitWorkerThread();
        super.onDestroy();
    }
    ...
    public boolean checkSelfPermission(String permission, int requestCode) {
        ...
        if (Manifest.permission.CAMERA.equals(permission)) {
            ((YuniApplication) getApplication()).initWorkerThread();
            workerThreadReady();
        }
        return true;
    }
    ...
    protected RtcEngine rtcEngine() {
        return ((YuniApplication) getApplication()).getWorkerThread().getRtcEngine();
    }

    protected final WorkerThread worker() {
        return ((YuniApplication) getApplication()).getWorkerThread();
    }

    protected final EngineConfig config() {
        return ((YuniApplication) getApplication()).getWorkerThread().getEngineConfig();
    }

    protected final MyEngineEventHandler event() {
        return ((YuniApplication) getApplication()).getWorkerThread().eventHandler();
    }
    ...
    protected CurrentUserSettings vSettings() {
        return YuniApplication.mVideoSettings;
    }
