...
final class BitmapUtils {
    ...
    public static Bitmap applyBrightnessFilter(Bitmap sourceBitmap) {
        Bitmap resultBitmap = sourceBitmap.copy(sourceBitmap.getConfig(), true);
        Paint paint = new Paint();
        paint.setColorFilter(setBrightness(CropImageView.progress + 20));
    ...
    static final class BitmapSampled {
        ...
        BitmapSampled(Bitmap bitmap, int sampleSize) {
            ...
            if (CropImageView.progress != 0) {
                this.bitmap = applyBrightnessFilter(bitmap);
            } else {
                this.bitmap = bitmap;
            }

            if(CropImageView.progress != 0)
                CropImageView.progress=0;
