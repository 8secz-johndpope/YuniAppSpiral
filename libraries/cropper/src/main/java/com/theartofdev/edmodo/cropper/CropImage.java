...
public final class CropImage {
     ...
     */
    public static void startPickImageActivity(@NonNull Activity activity, boolean includeDocuments, boolean includeCamera, boolean includeGallery) {

        List<Intent> allIntents = new ArrayList<>();
        PackageManager packageManager = activity.getPackageManager();

        // collect all camera intents if Camera permission is available
        if (!isExplicitCameraPermissionRequired(activity) && includeCamera && includeGallery) {
        ...
        } else if (!isExplicitCameraPermissionRequired(activity) && includeCamera) {
            allIntents.addAll(getCameraIntents(activity, packageManager));
        } else if (includeGallery) {
        ...
        Intent chooserIntent = Intent.createChooser(target, activity.getString(R.string.pick_image_intent_chooser_title));
    ...
    /**
     * Same astartPickImageActivity} method but instead of
    ...
    public static Intent getPickImageChooserIntent(@NonNull Context context) {
        return getPickImageChooserIntent(
                context, context.getString(R.string.pick_image_intent_chooser_title), false, true, false);
    }
    ...
    public static Uri getCaptureImageOutputUri(@NonNull Context context) {
        ...
        if (getImage != null) {
            ...
            file = new File(getImage.getPath(), "pickImageResult.jpeg");
            //outputFileUri = Uri.fromFile(new File(getImage.getPath(), "pickImageResult.jpeg"));
            outputFileUri = FileProvider.getUriForFile(context,
                    "com.android.yuniapp.provider",
                    file);
        }
    ...
    public static final class ActivityBuilder {
         ...
         */
        public void start(@NonNull Activity activity, boolean camera, boolean gallery) {
            mOptions.validate();
            mOptions.validate();
            ...
            bundle.putBoolean("gallery", gallery);
            intent.putExtra(CropImage.CROP_IMAGE_EXTRA_BUNDLE, bundle);
         ...
         */
        public void start(@NonNull Context context, @NonNull Fragment fragment, boolean camera, boolean gallery) {
