...
public class CropImageView extends FrameLayout {
    ...
    private PorterDuffColorFilter setBrightness(int progress) {
        if (progress >= 100) {
    ...
    /*private Bitmap applyBrightnessFilter(Bitmap sourceBitmap) {
        Bitmap resultBitmap = sourceBitmap.copy(sourceBitmap.getConfig(), true);
        Paint paint = new Paint();
        paint.setColorFilter(setBrightness(sb_value.getProgress() + 20));
